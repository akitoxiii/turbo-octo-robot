...
<head>
    ...
    <style>
        ...
        .confirm-container input[type="button"],
        ...
        .confirm-container input[type="button"]:hover,
...
<body>
    <div class="confirm-container">
        ...
        <label>管理権限</label>
        <p>
            <%= request.getAttribute("privilege").equals("1") ? "管理者" : "顧客" %>
        </p>
